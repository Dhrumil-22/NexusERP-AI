...
export default function ControlPanel({
  ...
  const [description, setDescription] = useState(
    "A glowing blue planet orbiting a bright yellow star.",
  );
    ...
    <div className="flex flex-col h-full bg-zinc-900/40 backdrop-blur-md">
      ...
      {activeTab === "create" ? (
        <form
          ...
          className="flex flex-col flex-1 overflow-y-auto p-5 gap-6 custom-scrollbar"
        >
          {/* Prompt Section */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  <option value="circle" className="bg-zinc-900">
                    Circle
                  </option>
                  <option value="rect" className="bg-zinc-900">
                    Rectangle
                  </option>
                  <option value="mixed" className="bg-zinc-900">
                    Mixed / Any
                  </option>
                </select>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <span className="text-xs text-zinc-400 flex items-center gap-1.5">
                  <PaintBucket size={12} /> Base Color
                </span>
              ...
              <div className="flex flex-col gap-2">
                <span className="text-xs text-zinc-400 flex items-center gap-1.5">
                  <FastForward size={12} /> Motion Speed
                </span>
                <select
                  value={speed}
                  ...
                  className="glass-input text-xs rounded-lg px-3 py-2 outline-none cursor-pointer appearance-none"
                >
                  <option value="slow" className="bg-zinc-900">
                    Slow & Smooth
                  </option>
                  <option value="normal" className="bg-zinc-900">
                    Normal
                  </option>
                  <option value="fast" className="bg-zinc-900">
                    Snappy
                  </option>
                </select>
              </div>
          ...
          <div className="flex gap-3 bg-white/5 p-3 rounded-xl border border-white/5 mt-2">
            ...
            <p className="text-[10px] text-zinc-400 leading-relaxed">
              Your prompt and visual settings are secretly merged and sent to
              the <strong>Gemini AI</strong>, which acts as a director to
              orchestrate the SVG canvas live!
            </p>
          </div>
        </form>
      ) : (
