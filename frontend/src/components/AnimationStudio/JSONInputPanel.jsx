    ...
    <div className="flex flex-col h-full p-4 gap-4">
      ...
      <div>
        ...
        <p className="text-xs mt-0.5" style={{ color: "#6b7280" }}>
          Describe what to animate. Press{" "}
          <kbd
            className="px-1 py-0.5 rounded text-xs font-mono"
            style={{ background: "#1e1e3f", color: "#a78bfa" }}
          >
            Ctrl+Enter
          </kbd>{" "}
          to generate.
      ...
      >
        ...
        <ol className="list-decimal list-inside space-y-1 opacity-90">
          ...
          <li>
            We secretly send your text to the <strong>Gemini API</strong>.
          </li>
          <li>
            Gemini acts like a director and writes a "script" holding
            dimensions, shapes, and movement timings.
          </li>
          <li>
            Our canvas reads this script and instantly draws the animation for
            you to see!
          </li>
        </ol>
      </div>
